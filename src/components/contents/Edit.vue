      ...
      <div class="layui-form layui-form-pane">
        <div class="layui-tab layui-tab-brief" lay-filter="user">
          <ul class="layui-tab-title">
            <li class="layui-this">Update post</li>
          </ul>
                ...
                <validation-observer ref="observer" v-slot="{ validate }">
                  <div class="layui-row layui-col-space15 layui-form-item">
                    ...
                    <div class="layui-col-md9">
                      <div class="layui-row">
                        <label for="L_title" class="layui-form-label">Title</label>
                        <div class="layui-input-block">
                  ...
                  <div class="layui-form-item">
                    <div class="layui-inline">
                      <label class="layui-form-label">Grant kiss</label>
                      ...
                      <div class="layui-form-mid layui-word-aux">Cannot change kiss after post</div>
                    </div>
                  </div>
                  <div class="layui-form-item">
                    <validation-provider
                  ...
                  <div class="layui-form-item">
                    <button type="button" class="layui-btn" @click="validate().then(submit)">Post</button>
                  </div>
                </validation-observer>
              </form>
            </div>
